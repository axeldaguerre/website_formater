...
#define HTMLTag_TBODY      (1ull << 37)
#define HTMLTag_THEAD      (1ull << 38)
#define HTMLTag_TR         (1ull << 39)
#define HTMLTag_TH         (1ull << 40)
#define HTMLTag_TD         (1ull << 41)
#define HTMLTag_FORM       (1ull << 42)
#define HTMLTag_INPUT      (1ull << 43)
#define HTMLTag_BUTTON     (1ull << 44)
#define HTMLTag_LABEL      (1ull << 45)
#define HTMLTag_HEAD       (1ull << 46)
#define HTMLTag_DOCTYPE    (1ull << 47)
#define HTMLTag_HTML       (1ull << 48)
#define HTMLTag_TITLE      (1ull << 49)
#define HTMLTag_BODY       (1ull << 50)
#define HTMLTag_FOOTER     (1ull << 51)
...
#define TBODY      { (U8*)"tbody",     sizeof("tbody")-1 }
#define THEAD      { (U8*)"thead",     sizeof("thead")-1 }
...
TAG(HTMLTag_TBODY,      Flow,      Block,  Paired, TBODY,      Null,        Null)
TAG(HTMLTag_THEAD,      Flow,      Block,  Paired, THEAD,      Null,        Null)
