...
internal Vec2F32 Add2F32(Vec2F32 a, Vec2F32 b) { return V2F32(a.x+b.x, a.y+b.y); }
internal Vec2F32 Sub2F32(Vec2F32 a, Vec2F32 b) { return V2F32(a.x-b.x, a.y-b.y); }
internal Vec2F32 Mul2F32(Vec2F32 a, Vec2F32 b) { return V2F32(a.x*b.x, a.y*b.y); }
internal Vec2F32 Div2F32(Vec2F32 a, Vec2F32 b) { return V2F32(a.x/b.x, a.y/b.y); }
internal Vec2F32 Scale2F32(Vec2F32 a, F32 scale) { return V2F32(a.x*scale, a.y*scale); }
internal F32 Dot2F32(Vec2F32 a, Vec2F32 b) { return (a.x*b.x + a.y*b.y); }
internal F32 LengthSquared2F32(Vec2F32 v) { return Dot2F32(v, v); }
internal F32 Length2F32(Vec2F32 v) { return SquareRoot(LengthSquared2F32(v)); }
internal Vec2F32 Normalize2F32(Vec2F32 v) { return Scale2F32(v, 1.f/Length2F32(v)); }
internal Vec2F32 Mix2F32(Vec2F32 a, Vec2F32 b, F32 t) { return V2F32(a.x*(1-t) + b.x*t, a.y*(1-t) + b.y*t); }
...
internal Vec2F64 Add2F64(Vec2F64 a, Vec2F64 b) { return V2F64(a.x+b.x, a.y+b.y); }
internal Vec2F64 Sub2F64(Vec2F64 a, Vec2F64 b) { return V2F64(a.x-b.x, a.y-b.y); }
internal Vec2F64 Mul2F64(Vec2F64 a, Vec2F64 b) { return V2F64(a.x*b.x, a.y*b.y); }
internal Vec2F64 Div2F64(Vec2F64 a, Vec2F64 b) { return V2F64(a.x/b.x, a.y/b.y); }
internal Vec2F64 Scale2F64(Vec2F64 a, F64 scale) { return V2F64(a.x*scale, a.y*scale); }
internal F64 Dot2F64(Vec2F64 a, Vec2F64 b) { return (a.x*b.x + a.y*b.y); }
internal F64 LengthSquared2F64(Vec2F64 v) { return Dot2F64(v, v); }
internal F64 Length2F64(Vec2F64 v) { return SquareRoot(LengthSquared2F64(v)); }
internal Vec2F64 Normalize2F64(Vec2F64 v) { return Scale2F64(v, 1.f/Length2F64(v)); }
internal Vec2F64 Mix2F64(Vec2F64 a, Vec2F64 b, F64 t) { return V2F64(a.x*(1-t) + b.x*t, a.y*(1-t) + b.y*t); }
...
internal Vec2S32 Add2S32(Vec2S32 a, Vec2S32 b) { return V2S32(a.x+b.x, a.y+b.y); }
internal Vec2S32 Sub2S32(Vec2S32 a, Vec2S32 b) { return V2S32(a.x-b.x, a.y-b.y); }
...
internal Vec3F64 Add3F64(Vec3F64 a, Vec3F64 b) { return V3F64(a.x+b.x, a.y+b.y, a.z+b.z); }
internal Vec3F64 Sub3F64(Vec3F64 a, Vec3F64 b) { return V3F64(a.x-b.x, a.y-b.y, a.z-b.z); }
internal Vec3F64 Mul3F64(Vec3F64 a, Vec3F64 b) { return V3F64(a.x*b.x, a.y*b.y, a.z*b.z); }
internal Vec3F64 Div3F64(Vec3F64 a, Vec3F64 b) { return V3F64(a.x/b.x, a.y/b.y, a.z/b.z); }
internal Vec3F64 Scale3F64(Vec3F64 a, F64 scale) { return V3F64(a.x*scale, a.y*scale, a.z*scale); }
internal F64 Dot3F64(Vec3F64 a, Vec3F64 b) { return (a.x*b.x + a.y*b.y + a.z*b.z); }
internal F64 LengthSquared3F64(Vec3F64 v) { return Dot3F64(v, v); }
internal F64 Length3F64(Vec3F64 v) { return SquareRoot(LengthSquared3F64(v)); }
internal Vec3F64 Normalize3F64(Vec3F64 v) { return Scale3F64(v, 1.f/Length3F64(v)); }
internal Vec3F64 Mix3F64(Vec3F64 a, Vec3F64 b, F64 t) { return V3F64(a.x*(1-t) + b.x*t, a.y*(1-t) + b.y*t, a.z*(1-t) + b.z*t); }
internal Vec3F64 Cross3F64(Vec3F64 a, Vec3F64 b) { return V3F64(a.y*b.z - a.z*b.y, a.z*b.x - a.x*b.z, a.x*b.y - a.y*b.x); }
internal Vec3F64
...
internal Vec4F32 Mul4F32(Vec4F32 a, Vec4F32 b) { return V4F32(a.x*b.x, a.y*b.y, a.z*b.z, a.w*b.w); }
...
internal Vec4F64 Add4F64(Vec4F64 a, Vec4F64 b) { return V4F64(a.x+b.x, a.y+b.y, a.z+b.z, a.w+b.w); }
internal Vec4F64 Sub4F64(Vec4F64 a, Vec4F64 b) { return V4F64(a.x-b.x, a.y-b.y, a.z-b.z, a.w-b.w); }
internal Vec4F64 Mul4F64(Vec4F64 a, Vec4F64 b) { return V4F64(a.x*b.x, a.y*b.y, a.z*b.z, a.w*b.w); }
internal Vec4F64 Div4F64(Vec4F64 a, Vec4F64 b) { return V4F64(a.x/b.x, a.y/b.y, a.z/b.z, a.w/b.w); }
internal Vec4F64 Scale4F64(Vec4F64 a, F64 scale) { return V4F64(a.x*scale, a.y*scale, a.z*scale, a.w*scale); }
internal F64 Dot4F64(Vec4F64 a, Vec4F64 b) { return (a.x*b.x + a.y*b.y + a.z*b.z + a.w*b.w); }
internal F64 LengthSquared4F64(Vec4F64 v) { return Dot4F64(v, v); }
internal F64 Length4F64(Vec4F64 v) { return SquareRoot(LengthSquared4F64(v)); }
internal Vec4F64 Normalize4F64(Vec4F64 v) { return Scale4F64(v, 1.f/Length4F64(v)); }
internal Vec4F64 Mix4F64(Vec4F64 a, Vec4F64 b, F64 t) { return V4F64(a.x*(1-t) + b.x*t, a.y*(1-t) + b.y*t, a.z*(1-t) + b.z*t, a.w*(1-t) + b.w*t); }
internal Vec4F64
...
internal Rng1F32 R1F32(F32 min, F32 max)
{
...
internal Rng1F32 Pad1F32(Rng1F32 r, F32 x) { return R1F32(r.min-x, r.max+x); }
internal F32 Center1F32(Rng1F32 r) { return (r.min + r.max)/2; }
internal B32 Contains1F32(Rng1F32 r, F32 v) { return r.min <= v && v < r.max; }
internal F32 Dim1F32(Rng1F32 r) { return AbsoluteValueF32(r.max - r.min); }
internal Rng1F32 Union1F32(Rng1F32 a, Rng1F32 b) { return R1F32(Min(a.min, b.min), Max(a.max, b.max)); }
internal Rng1F32 Intersection1F32(Rng1F32 a, Rng1F32 b) { return R1F32(Max(a.min, b.min), Min(a.max, b.max)); }
internal F32 Clamp1F32(Rng1F32 r, F32 v) { v = Clamp(r.min, v, r.max); return v; }

internal Rng1F64 R1F64(F64 min, F64 max)
{
...
internal Rng1F64 Pad1F64(Rng1F64 r, F64 x) { return R1F64(r.min-x, r.max+x); }
internal F64 Center1F64(Rng1F64 r) { return (r.min + r.max)/2; }
internal B32 Contains1F64(Rng1F64 r, F64 v) { return r.min <= v && v < r.max; }
internal F64 Dim1F64(Rng1F64 r) { return AbsoluteValueF64(r.max - r.min); }
internal Rng1F64 Union1F64(Rng1F64 a, Rng1F64 b) { return R1F64(Min(a.min, b.min), Max(a.max, b.max)); }
internal Rng1F64 Intersection1F64(Rng1F64 a, Rng1F64 b) { return R1F64(Max(a.min, b.min), Min(a.max, b.max)); }
internal F64 Clamp1F64(Rng1F64 r, F64 v) { v = Clamp(r.min, v, r.max); return v; }

internal Rng1S32 R1S32(S32 min, S32 max)
{
...
internal Rng1S32 Pad1S32(Rng1S32 r, S32 x) { return R1S32(r.min-x, r.max+x); }
internal S32 Center1S32(Rng1S32 r) { return (r.min + r.max)/2; }
internal B32 Contains1S32(Rng1S32 r, S32 v) { return r.min <= v && v < r.max; }
internal S32 Dim1S32(Rng1S32 r) { return AbsoluteValueS32(r.max - r.min); }
internal Rng1S32 Union1S32(Rng1S32 a, Rng1S32 b) { return R1S32(Min(a.min, b.min), Max(a.max, b.max)); }
internal Rng1S32 Intersection1S32(Rng1S32 a, Rng1S32 b) { return R1S32(Max(a.min, b.min), Min(a.max, b.max)); }
internal S32 Clamp1S32(Rng1S32 r, S32 v) { v = Clamp(r.min, v, r.max); return v; }

internal Rng1S64 R1S64(S64 min, S64 max)
{
...
internal Rng1S64 Pad1S64(Rng1S64 r, S64 x) { return R1S64(r.min-x, r.max+x); }
internal S64 Center1S64(Rng1S64 r) { return (r.min + r.max)/2; }
internal B32 Contains1S64(Rng1S64 r, S64 v) { return r.min <= v && v < r.max; }
internal S64 Dim1S64(Rng1S64 r) { return AbsoluteValueS64(r.max - r.min); }
internal Rng1S64 Union1S64(Rng1S64 a, Rng1S64 b) { return R1S64(Min(a.min, b.min), Max(a.max, b.max)); }
internal Rng1S64 Intersection1S64(Rng1S64 a, Rng1S64 b) { return R1S64(Max(a.min, b.min), Min(a.max, b.max)); }
internal S64 Clamp1S64(Rng1S64 r, S64 v) { v = Clamp(r.min, v, r.max); return v; }

internal Rng1U32 R1U32(U32 min, U32 max)
{
...
internal Rng1U32 Pad1U32(Rng1U32 r, U32 x) { return R1U32(r.min-x, r.max+x); }
internal U32 Center1U32(Rng1U32 r) { return (r.min + r.max)/2; }
internal B32 Contains1U32(Rng1U32 r, U32 v) { return r.min <= v && v < r.max; }
internal U32 Dim1U32(Rng1U32 r) { return (r.max - r.min); }
internal Rng1U32 Union1U32(Rng1U32 a, Rng1U32 b) { return R1U32(Min(a.min, b.min), Max(a.max, b.max)); }
internal Rng1U32 Intersection1U32(Rng1U32 a, Rng1U32 b) { return R1U32(Max(a.min, b.min), Min(a.max, b.max)); }
internal U32 Clamp1U32(Rng1U32 r, U32 v) { v = Clamp(r.min, v, r.max); return v; }
...
internal Rng1U64 Pad1U64(Rng1U64 r, U64 x) { return R1U64(r.min-x, r.max+x); }
internal U64 Center1U64(Rng1U64 r) { return (r.min + r.max)/2; }
internal B32 Contains1U64(Rng1U64 r, U64 v) { return r.min <= v && v < r.max; }
internal U64 Dim1U64(Rng1U64 r) { return AbsoluteValueU64(r.max - r.min); }
internal Rng1U64 Union1U64(Rng1U64 a, Rng1U64 b) { return R1U64(Min(a.min, b.min), Max(a.max, b.max)); }
internal Rng1U64 Intersection1U64(Rng1U64 a, Rng1U64 b) { return R1U64(Max(a.min, b.min), Min(a.max, b.max)); }
internal U64 Clamp1U64(Rng1U64 r, U64 v) { v = Clamp(r.min, v, r.max); return v; }
...
internal Rng2F32 Shift2F32(Rng2F32 r, Vec2F32 v) { r.x0 += v.x; r.y0 += v.y; r.x1 += v.x; r.y1 += v.y; return r; }
internal Rng2F32 Pad2F32(Rng2F32 r, F32 x) { return R2F32(Sub2F32(r.min, V2F32(x, x)), Add2F32(r.max, V2F32(x, x))); }
internal Vec2F32 Center2F32(Rng2F32 r) { return V2F32((r.min.x + r.max.x)/2, (r.min.y + r.max.y)/2); }
internal B32 Contains2F32(Rng2F32 r, Vec2F32 v) { return (r.min.x <= v.x && v.x <= r.max.x) && (r.min.y <= v.y && v.y <= r.max.y); }
internal Vec2F32 Dim2F32(Rng2F32 r) { return V2F32(AbsoluteValueF32(r.max.x - r.min.x), AbsoluteValueF32(r.max.y - r.min.y)); }
internal Rng2F32 Union2F32(Rng2F32 a, Rng2F32 b)
{
 return R2F32(V2F32(Min(a.min.x, b.min.x), Min(a.min.y, b.min.y)),
              V2F32(Max(a.max.x, b.max.x), Max(a.max.y, b.max.y)));
}
internal Rng2F32 Intersection2F32(Rng2F32 a, Rng2F32 b)
{
 return R2F32(V2F32(Max(a.min.x, b.min.x), Max(a.min.y, b.min.y)),
              V2F32(Min(a.max.x, b.max.x), Min(a.max.y, b.max.y)));
}
internal Vec2F32 Clamp2F32(Rng2F32 r, Vec2F32 v) { v.x = Clamp(r.min.x, v.x, r.max.x); v.y = Clamp(r.min.y, v.y, r.max.y); return v; }
...
internal Rng2F64 Shift2F64(Rng2F64 r, Vec2F64 v) { r.x0 += v.x; r.y0 += v.y; r.x1 += v.x; r.y1 += v.y; return r; }
internal Rng2F64 Pad2F64(Rng2F64 r, F64 x) { return R2F64(Sub2F64(r.min, V2F64(x, x)), Add2F64(r.max, V2F64(x, x))); }
internal Vec2F64 Center2F64(Rng2F64 r) { return V2F64((r.min.x + r.max.x)/2, (r.min.y + r.max.y)/2); }
internal B32 Contains2F64(Rng2F64 r, Vec2F64 v) { return (r.min.x <= v.x && v.x <= r.max.x) && (r.min.y <= v.y && v.y <= r.max.y); }
internal Vec2F64 Dim2F64(Rng2F64 r) { return V2F64(AbsoluteValueF64(r.max.x - r.min.x), AbsoluteValueF64(r.max.y - r.min.y)); }
internal Rng2F64 Union2F64(Rng2F64 a, Rng2F64 b)
{
 return R2F64(V2F64(Min(a.min.x, b.min.x), Min(a.min.y, b.min.y)),
              V2F64(Max(a.max.x, b.max.x), Max(a.max.y, b.max.y)));
}
internal Rng2F64 Intersection2F64(Rng2F64 a, Rng2F64 b)
{
 return R2F64(V2F64(Max(a.min.x, b.min.x), Max(a.min.y, b.min.y)),
              V2F64(Min(a.max.x, b.max.x), Min(a.max.y, b.max.y)));
}
internal Vec2F64 Clamp2F64(Rng2F64 r, Vec2F64 v) { v.x = Clamp(r.min.x, v.x, r.max.x); v.y = Clamp(r.min.y, v.y, r.max.y); return v; }
...
internal Rng2S32 Pad2S32(Rng2S32 r, S32 x) { return R2S32(Sub2S32(r.min, V2S32(x, x)), Add2S32(r.max, V2S32(x, x))); }
internal Vec2S32 Center2S32(Rng2S32 r) { return V2S32((r.min.x + r.max.x)/2, (r.min.y + r.max.y)/2); }
internal B32 Contains2S32(Rng2S32 r, Vec2S32 v) { return (r.min.x <= v.x && v.x < r.max.x) && (r.min.y <= v.y && v.y < r.max.y); }
internal Vec2S32 Dim2S32(Rng2S32 r) { return V2S32(AbsoluteValueS32(r.max.x - r.min.x), AbsoluteValueS32(r.max.y - r.min.y)); }
internal Rng2S32 Union2S32(Rng2S32 a, Rng2S32 b)
{
 return R2S32(V2S32(Min(a.min.x, b.min.x), Min(a.min.y, b.min.y)),
              V2S32(Max(a.max.x, b.max.x), Max(a.max.y, b.max.y)));
}
internal Rng2S32 Intersection2S32(Rng2S32 a, Rng2S32 b)
{
 return R2S32(V2S32(Max(a.min.x, b.min.x), Max(a.min.y, b.min.y)),
              V2S32(Min(a.max.x, b.max.x), Min(a.max.y, b.max.y)));
}
internal Vec2S32 Clamp2S32(Rng2S32 r, Vec2S32 v) { v.x = Clamp(r.min.x, v.x, r.max.x); v.y = Clamp(r.min.y, v.y, r.max.y); return v; }
...
internal Rng2S64 Pad2S64(Rng2S64 r, S64 x) { return R2S64(Sub2S64(r.min, V2S64(x, x)), Add2S64(r.max, V2S64(x, x))); }
internal Vec2S64 Center2S64(Rng2S64 r) { return V2S64((r.min.x + r.max.x)/2, (r.min.y + r.max.y)/2); }
internal B32 Contains2S64(Rng2S64 r, Vec2S64 v) { return (r.min.x <= v.x && v.x < r.max.x) && (r.min.y <= v.y && v.y < r.max.y); }
internal Vec2S64 Dim2S64(Rng2S64 r) { return V2S64(AbsoluteValueS64(r.max.x - r.min.x), AbsoluteValueS64(r.max.y - r.min.y)); }
internal Rng2S64 Union2S64(Rng2S64 a, Rng2S64 b)
{
 return R2S64(V2S64(Min(a.min.x, b.min.x), Min(a.min.y, b.min.y)),
              V2S64(Max(a.max.x, b.max.x), Max(a.max.y, b.max.y)));
}
internal Rng2S64 Intersection2S64(Rng2S64 a, Rng2S64 b)
{
 return R2S64(V2S64(Max(a.min.x, b.min.x), Max(a.min.y, b.min.y)),
              V2S64(Min(a.max.x, b.max.x), Min(a.max.y, b.max.y)));
}
internal Vec2S64 Clamp2S64(Rng2S64 r, Vec2S64 v) { v.x = Clamp(r.min.x, v.x, r.max.x); v.y = Clamp(r.min.y, v.y, r.max.y); return v; }
...
internal Rng3F32 Shift3F32(Rng3F32 r, Vec3F32 v) { r.x0 += v.x; r.y0 += v.y; r.z0 += v.z; r.x1 += v.x; r.y1 += v.y; r.z1 += v.z; return r; }
internal Rng3F32 Pad3F32(Rng3F32 r, F32 x) { return R3F32(Sub3F32(r.min, V3F32(x, x, x)), Add3F32(r.max, V3F32(x, x, x))); }
internal Vec3F32 Center3F32(Rng3F32 r) { return V3F32((r.min.x + r.max.x)/2, (r.min.y + r.max.y)/2, (r.min.z + r.max.z)/2); }
internal B32 Contains3F32(Rng3F32 r, Vec3F32 v) { return (r.min.x <= v.x && v.x <= r.max.x) && (r.min.y <= v.y && v.y <= r.max.y) && (r.min.z <= v.z && v.z <= r.max.z); }
internal Vec3F32 Dim3F32(Rng3F32 r) { return V3F32(AbsoluteValueF32(r.max.x - r.min.x), AbsoluteValueF32(r.max.y - r.min.y), AbsoluteValueF32(r.max.z - r.min.z)); }
internal Rng3F32 Union3F32(Rng3F32 a, Rng3F32 b)
{
...
internal Rng3F32 Intersection3F32(Rng3F32 a, Rng3F32 b)
{
...
internal Vec3F32 Clamp3F32(Rng3F32 r, Vec3F32 v) { v.x = Clamp(r.min.x, v.x, r.max.x); v.y = Clamp(r.min.y, v.y, r.max.y); v.z = Clamp(r.min.z, v.z, r.max.z); return v; }
